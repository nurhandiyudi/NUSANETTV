...
<div class="panel panel-default">
  <div class="panel-heading">Silahkan Ganti Password Anda untuk Keamanan</div>
<div class="container">
...
<p> </p> <h2> <input name="simpan" id="simpan" type="submit" class="btn btn-default" value="Simpan"> </form></h2>
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->
</div><!-- /.row -->
                   <div class="panel panel-default">
